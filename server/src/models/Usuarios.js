...
function validarCamposObrigatorios(dados) {
    ...
    const camposFaltando = camposObrigatorios.filter(campo => !bodyKeys.includes(campo));
...
export { camposObrigatorios, camposValidos, validarCamposObrigatorios, validarCamposValidos };
