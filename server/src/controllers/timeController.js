...
import { validarCamposObrigatoriosTime, validarCamposValidosTime } from '../models/Times.js';
...
class TimeController {
    ...
    static async atualizarTime(req, res) {
        ...
        try {
            ...
            res.status(500).send('Erro ao atualizar time. Por favor, tente novamente.');
        }
    }
